...
export default {
  ...
  flashcards: [
    ...
    { q: 'TELL THEM APART: strong acid vs concentrated acid', a: '<strong>Strong</strong> = fully dissociated (a property of the substance). <strong>Concentrated</strong> = a lot of solute per litre (a property of the solution).', explain: 'They are independent: you can have dilute hydrochloric acid (strong but not concentrated) and concentrated ethanoic acid (concentrated but weak). Exams exploit this constantly: a question comparing "equal concentrations of HCl and CH₃COOH" is testing whether you know that only the strong one dissociates fully, so it has the far higher [H₃O⁺] and lower pH.' },
    { q: 'TELL THEM APART: Ka vs pKa: which way round is stronger?', a: 'A <strong>larger Ka</strong> means a stronger acid. A <strong>smaller pKa</strong> means a stronger acid, because pKa = −log Ka.', explain: 'The sign flip catches people out under pressure. Anchor it with a known pair: ethanoic acid pKa 4.76, and a stronger acid like methanoic acid pKa 3.75. Lower number, stronger acid: the same logic as pH itself.' },
    { q: 'TELL THEM APART: equivalence point vs end point vs half-equivalence point', a: '<strong>Equivalence</strong> = stoichiometrically equal moles have reacted. <strong>End point</strong> = where the indicator actually changes colour. <strong>Half-equivalence</strong> = halfway there, where pH = pKa.', explain: 'A good indicator is one whose end point falls within the steep vertical section, so it coincides closely with equivalence. That is the whole basis of indicator choice. The half-equivalence point is the exam favourite because it lets you read pKa straight off a titration curve, since [HA] = [A⁻] makes the Henderson–Hasselbalch log term zero.' },
    { q: 'TELL THEM APART: a buffer vs a solution that merely resists dilution', a: 'A <strong>buffer</strong> contains significant amounts of BOTH a weak acid and its conjugate base, so it can neutralise added acid AND added base.', explain: 'Made either by mixing a weak acid with its salt, or by partially neutralising a weak acid with a strong base (which generates the conjugate in situ). A strong acid alone is not a buffer no matter how concentrated. It has no conjugate base reservoir to mop up added H₃O⁺.' },
    { q: 'TELL THEM APART: Kc/Ka vs the reaction quotient Q', a: 'K is the ratio of concentrations AT equilibrium; Q is the same expression evaluated at ANY moment. Q < K means the reaction shifts right; Q > K shifts left; Q = K means it is at equilibrium.', explain: 'For solubility this becomes the ionic product versus Ks: if the ionic product exceeds Ks, precipitation occurs. Framing a "will it precipitate?" question as a Q-versus-K comparison turns it from guesswork into a calculation.' },
    { q: 'TELL THEM APART: what a catalyst changes and what it does not', a: 'A catalyst speeds up the rate at which equilibrium is REACHED. It does NOT change the position of equilibrium or the value of K.', explain: 'It lowers the activation energy of forward and reverse reactions equally, so both rates rise by the same factor and the ratio at equilibrium is untouched. This is the most commonly dropped mark in Le Châtelier questions. Always say what a catalyst does not do.' },
